  ...
  return (
    <section className="technology-section" id="technology">
      <div className="technology-header">
        ...
        <h2>Precision Behind <span>Every Second</span></h2>
      ...
      <div className="technology-list">
        {technology.map((item, index) => (
          <article
            className={`technology-content ${index % 2 === 1 ? 'reverse' : ''}`}
            key={item.number}
          >
            <div className="technology-info">
              <p className="technology-number">{item.number}</p>
              <h3>{item.title}</h3>
            ...
            <div className="technology-visual">
              ...
              <span className="technology-caption">ALBERTO / {item.number}</span>
            </div>
          </article>
        ))}
      </div>
